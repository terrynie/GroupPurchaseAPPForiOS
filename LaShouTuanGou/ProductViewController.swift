...
//        self.navItem.titleView
    ...
    func tableView(tableView: UITableView, cellForRowAtIndexPath indexPath: NSIndexPath) -> UITableViewCell{
        ...
        var cell:UITableViewCell? = tableView.dequeueReusableCellWithIdentifier(productID) as? UITableViewCell
...
//            //可以比默认方式多增加一个subtitle
            cell = UITableViewCell(style: UITableViewCellStyle.Subtitle, reuseIdentifier: productID)
